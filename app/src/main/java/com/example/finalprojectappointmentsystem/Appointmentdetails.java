...
public class Appointmentdetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateImageView = findViewById(R.id.calendar);
        dateTextView = findViewById(R.id.selectDate); // Assuming this is the TextView to display the selected date
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Appointmentdetails.this, Success.class);
        ...
        for (Map.Entry<TextView, LocalTime> entry : timeSlots.entrySet()) {
            ...
            if (selectedDate.isEqual(currentDate)) {
                if (time.isBefore(currentTime.plusHours(1))) {
                    ...
                    timeSlot.setBackground(getResources().getDrawable(R.drawable.hoursbg)); // Assuming you have a disabled background
                } else {
