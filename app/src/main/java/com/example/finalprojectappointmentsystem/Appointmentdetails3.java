...
public class Appointmentdetails3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.appointmentdetails3);
        ...
        dateImageView = findViewById(R.id.calendar3);
        dateTextView = findViewById(R.id.selectDate3);
        ...
        btnBook = findViewById(R.id.btnBook3);
        btnBook.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Appointmentdetails3.this, Success.class);
